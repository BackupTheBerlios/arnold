...
const unsigned char *m_pWinapePokeDatabase;
const unsigned char **pGamePtrs;
...
void WinapePokeDatabase_Init(const char *pWinapePokeDatabase)
{
    ...
    m_pWinapePokeDatabase = pWinapePokeDatabase;
    ...
    if (memcmp(pPtr, "WPOK", 4)==0)
    {
        ...
        pGamePtrs = malloc(sizeof(unsigned char *)*nGames);
